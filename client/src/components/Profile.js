								...
								<tr key={charSheet.uuid}>
									<th scope="row">
										<NavLink
											exact
											to={'/characterSheet'}
											onClick={props.selectCharacter.bind(
												null,
												charSheet.uuid
											)}
									...
									<td className="center">
										{charSheet.charClassArray.length > 1
											? (function () {
													...
													for (
														let i = 0;
														i < maximumClassesDisplayed;
														i++
													) {
														charClass +=
															charSheet.charClassArray[i].class + ' ';
													}
									...
									<td className="center">
										{charSheet.charClassArray.length > 1
											? (function () {
													...
													for (
														let i = 0;
														i < charSheet.charClassArray.length;
														i++
													) {
														totalLevel += +charSheet.charClassArray[i]
															.level;
													}
													return totalLevel;
											  })()
